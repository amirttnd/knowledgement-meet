        ...
        <section class="highlight">
            ...
            <div class="container">
                <p class="lead text-center">
                    This proposal aims at detecting <b>the key forces</b> in a Knowledge Sharing network. We made the
                    design
                    of
                    ...
                    We can't wait on your feedback. We hope it will complete the tools you use to design, forecast,
                    decide,
                    excell.
                </p>
                            ...
                            <div class="timeline-block">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <span class="date wow flipInX"
                                          data-wow-delay="0.3s">{{home.sessionCommencement}}</span>
                                </div>
                                <!-- timeline-content -->
                            </div>
                            <!-- timeline-block -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img1.jpg" title=""><img
                                                    src="images/session-img1.jpg"
                                                    alt="gallery image"
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img2.jpg" title=""><img
                                                    src="images/session-img2.jpg"
                                                    alt="gallery image"
                                                    class="img-responsive wow fadeIn"
                                                    data-wow-delay="0.2s"></a>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img3.jpg" title=""><img
                                                    src="images/session-img3.jpg"
                                                    alt="gallery image"
                                                    class="img-responsive wow fadeIn"
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img4.jpg" title=""><img
                                                    src="images/session-img4.jpg"
                                                    alt="gallery image"
                                                    class="img-responsive wow fadeIn"
                                                    data-wow-delay="0.4s"></a>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img5.jpg" title=""><img
                                                    src="images/session-img5.jpg"
                                                    alt="gallery image"
                                                    class="img-responsive wow fadeIn"
                                                    data-wow-delay="0.2s"></a>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img6.jpg" title=""><img
                                                    src="images/session-img6.jpg"
                                                    alt="gallery image"
                                                    class="img-responsive wow fadeIn"
                                                    data-wow-delay="0.2s"></a>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img7.jpg" title=""><img
                                                    src="images/session-img7.jpg"
                                                    alt="gallery image"
                                                    class="img-responsive wow fadeIn"
                                                    data-wow-delay="0.4s"></a>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <a href="images/session-img8.jpg" title=""><img
                                                    src="images/session-img8.jpg"
                                                    alt="gallery image"
                                                    class="img-responsive wow fadeIn"
                                                    data-wow-delay="0.4s"></a>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 wow fadeInRight" data-wow-duration="2s">
                        ...
                        <p>Yes, you are always welcome to share your knowledge. Just let us know by submitting your
                            agenda
                            <a
                                    href="http://goo.gl/forms/93dega9dlp" target="_blank">here</a> as and we will get
                            back
                            to you.
                        </p>
                        ...
                        <p>If for some reason, your plan changes after filling the survey, please talk to the
                            IntelliMeet
